<?php
// public_html/api/other_cost.php
// รายการค่าใช้จ่ายอื่นๆ ของงานซ่อม 1 ใบ
//   GET /api/other_cost.php?job_id=120516   → { ok, job_id, total, rows:[...] }
// กรองด้วยคอลัมน์ oc_job_id (= r_id ของตาราง repair)
...
try {
  ...
  // ถ้า oc_id ไม่มีจริงในตาราง ให้เปลี่ยน ORDER BY เป็นคอลัมน์ PK ที่ถูกต้อง
  $st = $pdo->prepare("SELECT * FROM other_cost WHERE oc_job_id = ? ORDER BY oc_id ASC");
